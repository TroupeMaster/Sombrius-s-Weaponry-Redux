...
public class DiamondArrowRenderer extends EntityRenderer<DiamondArrowEntity> {
	...
	@Override
	public void render(DiamondArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
