...
public class CannonballRenderer extends EntityRenderer<CannonballEntity> {
	private static final ResourceLocation texture = new ResourceLocation("mortius_weaponry_redux:textures/entities/cannonball.png");
	...
	@Override
	public void render(CannonballEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
