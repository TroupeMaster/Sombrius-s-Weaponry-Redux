...
public class CopperArrowRenderer extends EntityRenderer<CopperArrowEntity> {
	...
	@Override
	public void render(CopperArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
