...
public class IronArrowRenderer extends EntityRenderer<IronArrowEntity> {
	...
	@Override
	public void render(IronArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
