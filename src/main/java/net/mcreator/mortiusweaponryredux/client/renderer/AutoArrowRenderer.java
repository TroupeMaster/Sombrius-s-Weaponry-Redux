...
public class AutoArrowRenderer extends EntityRenderer<AutoArrowEntity> {
	...
	@Override
	public void render(AutoArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(AutoArrowEntity entity) {
		return texture;
	}
}
