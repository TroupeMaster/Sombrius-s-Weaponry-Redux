...
public class AutoArrowEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Items.ARROW);

	public AutoArrowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MortiusWeaponryReduxModEntities.AUTO_ARROW.get(), world);
	}
	...
	public static AutoArrowEntity shoot(LivingEntity entity, LivingEntity target) {
		AutoArrowEntity entityarrow = new AutoArrowEntity(MortiusWeaponryReduxModEntities.AUTO_ARROW.get(), entity, entity.level());
