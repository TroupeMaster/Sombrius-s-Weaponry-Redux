...
import net.mcreator.mortiusweaponryredux.procedures.MusketBallPlacementProcedure;
...
public class MusketBallPouchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MusketBallPouchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
