...
public class NetheriteQuiverGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NetheriteQuiverGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MortiusWeaponryReduxModMenus.NETHERITE_QUIVER_GUI.get(), id);
