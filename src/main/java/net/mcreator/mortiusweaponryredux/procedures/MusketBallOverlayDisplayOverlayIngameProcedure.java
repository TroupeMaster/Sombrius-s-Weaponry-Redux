...
public class MusketBallOverlayDisplayOverlayIngameProcedure {
	public static boolean execute(Entity entity) {
		...
		if (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == MortiusWeaponryReduxModItems.FLINTLOCK_PISTOL.get()
				...
				&& (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().getBoolean("mortius:musket_ball") == true) {
			return true;
				...
				&& (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getOrCreateTag().getBoolean("mortius:musket_ball") == true) {
			return true;
		}
		return false;
	}
