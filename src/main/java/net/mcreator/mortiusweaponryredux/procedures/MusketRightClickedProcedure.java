...
public class MusketRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getBoolean("mortius:musket_ball") == true) {
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mortius_weaponry_redux:musket_shoot")), SoundSource.PLAYERS, 3, 1);
				} else {
					_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mortius_weaponry_redux:musket_shoot")), SoundSource.PLAYERS, 3, 1, false);
				}
			}
				...
				_level.sendParticles(ParticleTypes.POOF, x, (y + 0.5), z, 15, 1, 1, 1, 0.5);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 2, (int) 0.2, (byte) 1);
					_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
					_entityToSpawn.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, (float) 2.8, 1);
		...
		if (itemstack.getOrCreateTag().getBoolean("mortius:spiked_ball") == true) {
				...
				_level.sendParticles(ParticleTypes.POOF, x, (y + 0.5), z, 15, 1, 1, 1, 0.5);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 3, (int) 0.2, (byte) 1);
					_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
					_entityToSpawn.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, (float) 2.8, 1);
					projectileLevel.addFreshEntity(_entityToSpawn);
				}
		...
		if (itemstack.getOrCreateTag().getBoolean("mortius:explosive_ball") == true) {
				...
				_level.sendParticles(ParticleTypes.POOF, x, (y + 0.5), z, 15, 1, 1, 1, 0.5);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 1, (int) 0.2, (byte) 1);
					_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
					_entityToSpawn.shoot(_shootFrom.getLookAngle().x, _shootFrom.getLookAngle().y, _shootFrom.getLookAngle().z, (float) 2.8, 1);
					projectileLevel.addFreshEntity(_entityToSpawn);
				}
		...
		if (itemstack.getOrCreateTag().getBoolean("mortius:heavy_ball") == true) {
				...
				_level.sendParticles(ParticleTypes.POOF, x, (y + 0.5), z, 15, 1, 1, 1, 0.5);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 4, (int) 0.2, (byte) 1);
					_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
		...
		if (itemstack.getOrCreateTag().getBoolean("mortius:phantom_ball") == true) {
				...
				_level.sendParticles(ParticleTypes.POOF, x, (y + 0.5), z, 15, 1, 1, 1, 0.5);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 4, (int) 0.1, (byte) 2);
					_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
