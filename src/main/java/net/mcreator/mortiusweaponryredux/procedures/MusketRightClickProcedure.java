...
public class MusketRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		ItemStack itemData = ItemStack.EMPTY;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == MortiusWeaponryReduxModItems.BAYONET.get()) {
			itemData = itemstack;
			(entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).shrink(1);
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(MortiusWeaponryReduxModItems.BAYONET_MUSKET.get()).copy();
