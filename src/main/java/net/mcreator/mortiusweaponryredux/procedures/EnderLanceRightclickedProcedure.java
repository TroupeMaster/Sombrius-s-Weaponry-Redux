...
public class EnderLanceRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 12, 24); index0++) {
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.PORTAL, (x + Mth.nextDouble(RandomSource.create(), -0.6, 0.6)), (y + Mth.nextDouble(RandomSource.create(), 0.25, 1.6)), (z + Mth.nextDouble(RandomSource.create(), -0.6, 0.6)), 1, 0, 0, 0, 0.1);
		}
