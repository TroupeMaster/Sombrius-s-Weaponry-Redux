...
import net.mcreator.mortiusweaponryredux.procedures.MusketBallRightclickedProcedure;
...
public class MusketBallItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MusketBallRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
