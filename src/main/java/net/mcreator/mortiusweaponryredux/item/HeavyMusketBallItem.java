...
import net.mcreator.mortiusweaponryredux.procedures.HeavyBallClickProcedure;
...
public class HeavyMusketBallItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		HeavyBallClickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
}
